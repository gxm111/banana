...
public class SwipeControlCustomizationHats : MonoBehaviour {
	...
	public static bool allowInput = true; //If you don't want to allow mouse or touch input and only want to use this control for animating a value, set this to false.
		...
		if(controlEnabled) {
			...
			if(allowInput) {
				...
				if(Input.GetMouseButton(0) || Input.GetMouseButtonUp(0)) {
					pos = new Vector3(Input.mousePosition[0], Input.mousePosition[1], 0.0f);
